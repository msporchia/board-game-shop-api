...
/**
 * The snapshot carries no price — pricing is this service's domain. Deterministic
 * demo rule derived from the game's own fields, so reseeding always reproduces the
 * same catalog.
 */
